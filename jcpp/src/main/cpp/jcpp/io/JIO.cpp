...
namespace jcpp{
    namespace io{
        JIO::JIO():JPackage("jcpp.io",JPackage::getClazz()){//better class
            ...
            classes->push_back(JDefaultFileSystem::getClazz());
            classes->push_back(JEOFException::getClazz());
            classes->push_back(JExternalizable::getClazz());
            classes->push_back(JFile::getClazz());
            classes->push_back(JFileFilter::getClazz());
            classes->push_back(JFileInputStream::getClazz());
            classes->push_back(JFilenameFilter::getClazz());
            classes->push_back(JFileNotFoundException::getClazz());
            classes->push_back(JFileOutputStream::getClazz());
            classes->push_back(JFileReader::getClazz());
            classes->push_back(JFileWriter::getClazz());
            ...
            classes->push_back(JFileSystem::getClazz());
            ...
            classes->push_back(JStringBufferInputStream::getClazz());
            ...
            classes->push_back(JWinNTFileSystem::getClazz());
