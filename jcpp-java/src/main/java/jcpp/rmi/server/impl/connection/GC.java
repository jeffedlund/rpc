...
public class GC implements IGC {
    ...
    public GC(ExecutorService executorService, ScheduledExecutorService scheduledExecutorService, ConnectionConfiguration connectionConfiguration) {
    ...
    protected class EndPointInfo implements Runnable {
        ...
        public String toString() {
            String[] strArray;
            synchronized (this) {
                strArray = exportedObjects.keySet().toArray(new String[0]);
            }
            String toString = "";
            if (strArray != null) {
            ...
            return "GC.EndPointInfo[RemoteEndPoint: " + remoteEndPoint + ", Ids of exportedObjects:" + toString + "]";
        }
    }
